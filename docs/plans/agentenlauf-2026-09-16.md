...
### Assets, Korrekturrunde 3b

Auf meine Sichtpruefung hin ging die Runde mit vier benannten Punkten zurueck. Drei davon sind erledigt, und zwar nachpruefbar im Bild statt nur im Bericht.

- **Augen:** Das Eigenleuchten ist von 3,0 auf 1,35 zurueckgenommen, Iris und Pupille sitzen als eigenes Material auf einem ins Netz gebrannten Merkmal statt auf einer posenabhaengigen Rechnung. In der Nahaufnahme liest sich das Auge jetzt als Ring aus Glut um eine dunkle Pupille, der Rand der Hoehle wirft sichtbar Schatten; aus der Spielkamera bleibt trotzdem ein klarer Lichtpunkt. Beide Bedingungen gelten gleichzeitig - das war die Anforderung.
- **Brute:** Organische Materialien haben eine eigene Rauheitsformel bekommen (Fleisch 0,649, Schulterplatten 0,518, Imp-Haut 0,746). Das nasse Plastik ist weg, die Oberflaeche liest sich matt.
- **Abbruch statt stiller Luecke:** Jeder Backvorgang wird gegen die tatsaechlich geschriebene Datei geprueft; bei einer Luecke wird bis zu fuenfmal neu gebacken, sonst bricht der Lauf mit Fehler ab, bevor irgendetwas ausgeliefert wird. Dabei stellte sich heraus, dass der Fehlschlag am Horn **nicht** zufaellig war, sondern zu hundert Prozent reproduzierbar - die Diagnose 'schwankende Umgebung' aus Runde 3 war also falsch. Geloest ist es ueber einen vom Pfadverfolger unabhaengigen Weg (Kruemmung gerechnet, Verdeckung per Strahl, eigener Rasterisierer).
