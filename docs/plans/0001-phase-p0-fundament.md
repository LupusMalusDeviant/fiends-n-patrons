...
|----|-------|----------------------|
| WP1 | erledigt | Beide Repos angelegt und gepusht (zunächst als private GitHub-Repos `LupusMalusDeviant/grimoire` und `LupusMalusDeviant/fiends-n-patrons`; seit 2026-09-15 öffentlich, siehe „Abweichungen“); gepinnte Toolchain 1.98.1; Fenster-Bibliothek winit (Engine-ADR-0001); Lizenzentscheid aus WP1.4 nachgetragen am 2026-09-15: Alle Rechte vorbehalten, `LICENSE` und `license-file` in beiden Repos ([ADR-0012](../adr/0012-lizenz-alle-rechte-vorbehalten.md), schließt P0-Rest R-09) |
